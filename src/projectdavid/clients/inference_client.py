...
class InferenceClient:
    ...
    def __init__(self, base_url: str, api_key: Optional[str] = None,
        ...
        self.timeout = timeout if timeout is not None else DEFAULT_TIMEOUT  # Use provided or default timeout
    ...
    def create_completion_sync(
        ...
        try:
            ...
            logging_utility.warning(
                "asyncio.run() detected existing loop or context: %s. Using existing loop.", e)
        ...
        async with httpx.AsyncClient(
            ...
            try:
                ...
                logging_utility.error(
                    ...
                    str(e), e.response.status_code, error_body
                )
                raise
